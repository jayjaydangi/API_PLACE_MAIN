...
const APIDetailPage = ({ apiDetailData, api_id }) => {
    ...
    <div className="w-full relative bg-colors-background-bg-primary overflow-hidden flex flex-col items-center justify-start text-left text-5xl text-colors-text-text-primary-900 font-text-lg-regular">
      ...
      <Container className="">
        <Row className="">
          ...
          <Col lg={2} md={12} sm={12} className="mt-5" >
      ...
      <Container className="">
        <Row className="">
          <Col className="">
            <div className=" bg-colors-background-bg-primary overflow-hidden flex flex-col items-center justify-start py-spacing-6xl px-0 box-border gap-[32px_0px] z-[1]">

              <div className="self-stretch relative leading-[32px] font-semibold">
                More from John Doe
                <h6 className="self-stretch relative text-base leading-[24px] text-coolgray-90"> Find more APIs from the same publisher</h6>
              </div>
              <div >
