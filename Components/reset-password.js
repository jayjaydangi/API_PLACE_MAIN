const ResetPassword = () => {
  return (
    <div className="w-[1440px] bg-colors-background-bg-primary flex flex-col items-center justify-start pt-spacing-7xl px-0 pb-spacing-6xl box-border min-h-[960px] text-left text-xl text-colors-gray-dark-mode-900 font-text-lg-regular">
      <div className="w-full flex flex-col items-center justify-start py-0 px-container-padding-desktop box-border gap-[64px_0px] max-w-[1280px]">
        ...
        <div className="w-full flex flex-col items-center justify-start gap-[32px_0px] max-w-[360px] text-sm text-colors-text-text-primary-900">
          ...
          <div className="overflow-hidden flex flex-row items-center justify-center gap-[0px_6px] text-component-colors-components-buttons-tertiary-button-tertiary-fg">
            <img
